...
app.include_router(conversations.router, prefix="/api", tags=["history"])
app.include_router(recents.router, prefix="/api", tags=["history"])
app.include_router(search.router, prefix="/api", tags=["chat"])
